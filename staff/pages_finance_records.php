            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul><!--Breadcrumps-->
                        ...
                        <li class="active-bre"><a href="#">Finance Records</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-3">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <?php
                                        //code for summing up all the amount paid for flight tickets.
                                        $result ="SELECT SUM(jf_amt_paid) FROM jordan_flights_reservation_payments";
                                        ...
                                        $stmt->close();
                                    ?>
                                    <h4>Ticket Payment | Finance Records : Total Flight Fare Paid So Far 💰 Ksh <?php echo $💸 ;?> </h4>
